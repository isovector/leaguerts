...
namespace LeagueEngine.Visual {
    ...
    public class ParticleSystem : DrawableGameComponent {
        ...
        /// Constructor.
        /// </summary>
        public ParticleSystem(string vid)
            : base(League.Engine) {
            Engine = League.Engine;
            this.content = League.Engine.Content;
        ...
        public override void Initialize() {
            Engine.Script.InvokeSyncEvent("particlesystem", Vid, settings);
        ...
        public override void Update(GameTime gameTime) {
            ...
            effectViewParameter.SetValue(League.Engine.CurrentMap.World * League.Engine.CurrentMap.Rotation * League.view);
            effectProjectionParameter.SetValue(League.projection);
        ...
        private static Dictionary<string, ParticleSystem> ParticleSystems = new Dictionary<string, ParticleSystem>();
